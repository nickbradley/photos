...
import { InsightResponse, InsightResponseSuccessBody } from "../src/controller/IInsightFacade";
...
describe("InsightFacade Add/Remove Dataset", function () {
    ...
    it("Should add a valid dataset", async () => {
        ...
        try {
            response = await insightFacade.addDataset(id, datasets[id]);
        } catch (err) {
            response = err;
        } finally {
    ...
    before(async function () {
        ...
        try {
            ...
            for (const [id, content] of Object.entries(datasets)) {
                responsePromises.push(insightFacade.addDataset(id, content));
            }
